...
words = {
    "apple":"papel","mango":"oangm",        "achieve":"hveecia","cart":"rcat",        "petals":"seltap","mouse":"uosme","cloud":"ldouc",        "elephant":"ateplehen"
}
...
def new_word():
    ...
    label.config(text=current_word,font=("Helvetica",20),fg="gray0",bg="CornflowerBlue")
...
def check_answer():
    ...
    if correct_answer == a:
        ...
        points = points + 1
        display.config(text="Score:"+str(points))
        new_word()
    else:
...
new_word()
display = Label(window,text="Score:")
print("Score:", points)
